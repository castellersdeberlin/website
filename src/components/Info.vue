...
export default {
  ...
  methods: {
    ...
    icon(i) {
      switch (i % 3) {
        case 1: return 'mdi-information-outline';
        case 2: return 'mdi-contacts-outline';
  ...
  info:
    ...
    2:
      ...
      body: >
        ...
        APRIL: Geschichte und Bedeutung der Castells

        MAI: Frauen in der Castells Welt
