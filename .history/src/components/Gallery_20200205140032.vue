...
<v-container>
  ...
  <LightBox
    :images="Object.values(this.currentGallery[0])"
    ref="lightbox"
    :show-caption="true"
    :show-light-box="true"
  >
...
export default {
  ...
  methods: {
    ...
    imagesN(index) {
      ...
      clicked gallery:
      index:  ${index}
      ${this.galleries[index][0]}
      `);

      this.$set(this.currentGallery, 0, this.$t('galleries')[index]);
      // this.currentGallery = this.$t('galleries')[index];
      // this.$t('galleries')[index].map((item) => {
        // return this.currentGallery.push(item);
      // });
