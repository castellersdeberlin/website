...
export default {
  ...
  computed: {
    fetchData() {
      console.log(this.$t('galleries'));
      // this.galleries = [...Object.values(this.$t('galleries'))];
      this.galleries = Object.assign(this.$t('galleries'))
      // this.galleries = [ ...this.$t('galleries') ];
      // this.$set(this.galleries, 0, this.$('galleryies'))
